...
public class LeaveRequests_ApprovedAdapter extends RecyclerView.Adapter<LeaveRequests_ApprovedAdapter.ViewHolder> {
    ...
    public LeaveRequests_ApprovedAdapter(Context context, JSONArray data) {
    ...
    @NonNull
    @Override
    public LeaveRequests_ApprovedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).
                inflate(R.layout.leaverequest_pending_details_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull LeaveRequests_ApprovedAdapter.ViewHolder holder, int position) {
